  ...
  return (
    <>
      ...
      <div className="container treatment-section-overview">
        ...
        <p>
          Here at Joser Forever, we firmly stand that without addressing our
          ...
          <br />
          <br />
          Methods used by Joser Forever are non-invasive, distinct, and
      ...
      <div className="treatment-section-activities">
        <div className="treatment-left">
          ...
          <p>
            Joser Forever promotes fun activities that clients learn how to
